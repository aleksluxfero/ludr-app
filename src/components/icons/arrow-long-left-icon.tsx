...
interface ArrowLongLeftIconProps extends SVGProps<SVGSVGElement> {}

const ArrowLongLeftIcon: FC<ArrowLongLeftIconProps> = ({className, ...props}) => {
  return (
    <svg {...props} className={className} xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 512 512">
      <path
